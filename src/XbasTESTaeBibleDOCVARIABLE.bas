...
' and deferred diagnostic routines.
...
NewTestament:
    ...
    ActiveDocument.Variables("John").value = 705
    ActiveDocument.Variables("Acts").value = 727
    ActiveDocument.Variables("Rom").value = 752
    ActiveDocument.Variables("1Cor").value = 763
    ActiveDocument.Variables("2Cor").value = 774
    ActiveDocument.Variables("Gal").value = 782
    ActiveDocument.Variables("Eph").value = 787
    ActiveDocument.Variables("Phil").value = 792
    ActiveDocument.Variables("Col").value = 796
    ActiveDocument.Variables("1Thess").value = 800
    ActiveDocument.Variables("2Thess").value = 804
    ActiveDocument.Variables("1Tim").value = 806
    ActiveDocument.Variables("2Tim").value = 810
    ActiveDocument.Variables("Tit").value = 813
    ActiveDocument.Variables("Phlm").value = 816
    ActiveDocument.Variables("Heb").value = 818
    ActiveDocument.Variables("Jas").value = 827
    ActiveDocument.Variables("1Pet").value = 831
    ActiveDocument.Variables("2Pet").value = 835
    ActiveDocument.Variables("1John").value = 838
    ActiveDocument.Variables("2John").value = 842
    ActiveDocument.Variables("3John").value = 844
    ActiveDocument.Variables("Jude").value = 846

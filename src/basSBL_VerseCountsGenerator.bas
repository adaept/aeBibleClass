...
'    - Orthodox versification
    ...
    d.Add 4, Array(54, 34, 51, 49, 31, 27, 89, 26, 23, 36, 35, 16, 33, 45, 41, 50, 13, 32, 22, 29, 35, 41, 30, 25, 18, 65, 23, 31, 40, 16, 54, 42, 56, 29, 34, 13)
    ...
    d.Add 10, Array(27, 32, 39, 12, 25, 23, 29, 18, 13, 19, 27, 31, 39, 33, 37, 23, 29, 32, 44, 26, 22, 51, 39, 25)
    ...
    d.Add 14, Array(17, 18, 17, 22, 14, 42, 22, 18, 31, 19, 23, 16, 23, 14, 19, 14, 19, 34, 11, 37, 20, 12, 21, 27, 28, 23, 9, 27, 36, 27, 21, 33, 25, 33, 27, 23)
    ...
    d.Add 26, Array(28, 10, 27, 17, 17, 14, 27, 18, 11, 22, 25, 28, 23, 23, 8, 63, 24, 32, 14, 49, 32, 31, 49, 27, 17, 21, 36, 26, 21, 26, 18, 32, 33, 31, 15, 38, 28, 23, 29, 49, 26, 20, 27, 31, 25, 24, 23, 35)
    ...
    d.Add 33, Array(16, 13, 12, 13, 15, 16, 20)
    d.Add 34, Array(15, 13, 19)
    d.Add 35, Array(17, 20, 19)
    d.Add 36, Array(18, 15, 20)
    d.Add 37, Array(15, 23)
    d.Add 38, Array(21, 13, 10, 14, 11, 15, 14, 23, 17, 12, 17, 14, 9, 21)

...
- **Dual-licensed:** `LGPL-3.0-or-later OR LicenseRef-adaept-Commercial` (see `LICENSING.md`); all Class modules and the production ribbon `.bas` modules carry the SPDX dual-license header

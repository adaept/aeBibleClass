...
'    - Orthodox versification
    ...
    d.Add 10, ToOneBasedLongArray(Array(27, 32, 39, 12, 25, 23, 29, 18, 13, 19, 27, 31, 39, 33, 37, 23, 29, 33, 43, 26, 22, 51, 39, 25), "2 Samuel")
    d.Add 11, ToOneBasedLongArray(Array(53, 46, 28, 34, 18, 38, 51, 66, 28, 29, 43, 33, 34, 31, 34, 34, 24, 46, 21, 43, 29, 53), "1 Kings")
    d.Add 12, ToOneBasedLongArray(Array(18, 25, 27, 44, 27, 33, 20, 29, 37, 36, 21, 21, 25, 29, 38, 20, 41, 37, 37, 21, 26, 20, 37, 20, 30), "2 Kings")
    ...
    d.Add 14, ToOneBasedLongArray(Array(17, 18, 17, 22, 14, 42, 22, 18, 31, 19, 23, 16, 22, 15, 19, 14, 19, 34, 11, 37, 20, 12, 21, 27, 28, 23, 9, 27, 36, 27, 21, 33, 25, 33, 27, 23), "2 Chronicles")
    ...
    d.Add 22, ToOneBasedLongArray(Array(17, 17, 11, 16, 16, 13, 13, 14), "Song of Solomon")
    ...
    d.Add 64, ToOneBasedLongArray(Array(14), "3 John")
